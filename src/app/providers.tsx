...
import { RainbowKitProvider, lightTheme, darkTheme, connectorsForWallets, Wallet, type WalletDetailsParams } from "@rainbow-me/rainbowkit";
...
import { injectedWallet, rainbowWallet, metaMaskWallet, baseAccount } from "@rainbow-me/rainbowkit/wallets";
import { porto } from "porto/wagmi";
import { createClient, http } from "viem";

// Use a placeholder project ID for build time, real one should be set in .env.local
const projectId = process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID || "placeholder-for-build";

// Custom Porto wallet configuration for proper RainbowKit integration (mobile support)
const portoWallet = (): Wallet => ({
  id: "xyz.ithaca.porto",
  name: "Email or Passkey",
  iconUrl:
  ...
  [
    {
      ...
      wallets: [portoWallet, metaMaskWallet, baseAccount, injectedWallet],
    },
    {
      groupName: "Popular",
